...
public class OfferCreatedEvent extends  BaseEvent<String>{
    ...
    public OfferCreatedEvent(String id, String title, InfoGeneralDTO generalInfo, String positionHeld, String generalProfile, List<TechnologyDTO> requiredTechs, List<DegreeDTO> requiredDegrees, int experMin, int availablePlace) {
        super(id);
        this.title = title;
